...
OV_CONFIG_RELEASE_INTERNAL_OPTION(ov::intel_gpu, dynamic_quantization_precompute_sum, true, "Precompute partial of activation for faster dynamic quantization in case of asymmetric weight")
